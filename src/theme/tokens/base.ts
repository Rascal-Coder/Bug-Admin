...
export const baseThemeTokens = {
	...
	zIndex: {
		...
		drawer: "80", // z-index of the drawer/navigation menu
		modal: "80", // z-index of the modal/dialog
		snackbar: "80", // z-index of the notification/toast/alert/message
		tooltip: "80", // z-index of the tooltip
